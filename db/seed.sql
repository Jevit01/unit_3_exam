DROP DATABASE IF EXISTS marinebio;
CREATE DATABASE marinebio;
...
VALUES (1, 'Flip'), (1, 'Skip'), (2, 'Jenkins'), (3, 'Sally'), (4, 'Flapjack'), (4, 'Gibbous'), (4, 'Nox');

INSERT INTO habitats (category)
VALUES ('Shallows'), ('Coral Reef'), ('Tide Pools'), ('Deeps');

INSERT INTO taggings (animals_id, researchers_id)
VALUES (1, 5), (1, 4), (2, 3), (3, 1), (4, 2), (5, 4), (6, 4), (7, 2);

INSERT INTO sightings (researchers_id, species_id, habitats_id)
